...
$.fn.media.defaults = {
	...
	bgColor:	'rgba(255,255,255,0)',	// background color
...
function generate(el, opts, player) {
	...
	if (player == 'iframe') {
		o = $('<iframe id="pdfFrame" frameborder="0"  marginheight="0" marginwidth="0"' + ' width="' + opts.width + '" height="' + opts.height + '" >')
		o.attr('src', opts.src)
